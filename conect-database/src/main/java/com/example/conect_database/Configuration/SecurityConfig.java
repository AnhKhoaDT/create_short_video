...
public class SecurityConfig {
    ...
    private  final String[] PUBLIC_ENDPOINTS = {"/users","/auth/log-in","/auth/verify", "/auth/logout","/auth/refresh","/trends","trends/suggestions","/suggest","/scripts/generate","/tts","/images/generate"};
